...
saveRDS(chemistry_ssp126_CNRM_list,"./Objects/Transient/Barents_Sea/CNRM/chemistry_SSP126_CNRM.rds")
...
saveRDS(chemistry_ssp370_CNRM_list,"./Objects/Transient/Barents_Sea/CNRM/chemistry_SSP370_CNRM.rds")
