...
saveRDS(chemistry_ssp126_GFDL_list,"./Objects/Transient/East_Greenland/GFDL/chemistry_SSP126_GFDL.rds")
...
saveRDS(chemistry_ssp370_GFDL_list,"./Objects/Transient/East_Greenland/GFDL/chemistry_SSP370_GFDL.rds")
